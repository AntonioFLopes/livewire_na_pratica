<div class="max-w-7xl mx-auto py-15 px-4" x-data="creditCard()"
    ...
    <form action="" name="creditCard" class="w-full max-w-7xl mx-auto">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full py-4 px-3 mb-6">
                <button @click.prevent="cardToken" type="submit" class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded">
                    Realizar Assinatura
                </button>
            </p>
    ...
    <script>
        /*
         - Ter uma sessão vinda o pagseguro
         - Vai precisar importar o javascript do pagSeguro..
         - Recuper a bandeira do cartão
         Precisar recuperar o token do cartão
         - enviar o token eo sender hash para o componente php
         */
        function creditCard() {
            return {
                brandName: '',
