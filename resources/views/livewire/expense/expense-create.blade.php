<div class="max-w-7xl mx-auto py-15 px-4">
    <br>
    <h2 class="font-semibold text-2xl text-green-700">Cadastrar Registros</h2>
    <br>
    @include('includes.message')

    <form action="" wire:submit.prevent="createExpense" class="w-full max-w-7xl mx-auto">
        <p class="flex flex-wrap -mx-3 mb-6">
        ...
        <p class="w-full px-3 mb-6 md:mb-0">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Foto do
                Comprovante</label>
            ...
            @if($photo)
                <img src="{{$photo->temporaryUrl()}}" alt="{{$photo}}" width="80px" height="80px"
        ...
        <p class="w-full px-3 mb-6 md:mb-0">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Data de Registro</label>
