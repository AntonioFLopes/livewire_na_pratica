<div class="max-w-7xl mx-auto py-15 px-4">
 <h2 class="font-semibold text-2xl text-green-700 py-4">Atualizar Registro</h2>

    @include('includes.message')
    <img src="{{route('expenses.photo', $expense->id)}}" alt="{{$photo}}" width="80px" height="80px" style="border-radius:80px; object-fit: fill;">
